...
![Fig.1 state model used in the HMM segmentation (Methods); Up, regions of predominant initiation, i.e. AS; Down, regions of predominant termination, i.e. DS; Flat1 and Flat2, FS. ](https://github.com/CL-CHEN-Lab/OK-Seq/blob/master/img/fig1.png) 
